			...
			<div id="page-body">
				...
				<div class="body-contents">
					<div class="inner">
						<div class="contents">
							<br><br>
							<table id="boardPostTable" bbs-post-id="${postInfo.bbsPostId}" border="1" style="width: 80%;">
								<tr>
							...
							<br><br>
							<button style="display: inline-block; float: right; margin-left: 10px;" type="submit" class="add btn btn-success todo-list-add-btn" id="postModify">modify</button>
							<button style="display: inline-block; float: right;" type="submit" class="add btn btn-primary todo-list-add-btn" id="postList" onclick="goPostList();">List</button>
						</div>
						<br><br>
					</div>
				</div>
